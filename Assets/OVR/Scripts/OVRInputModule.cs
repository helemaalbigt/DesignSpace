...
#region PointerEventData pool
        ...
        {
			var pressed = Input.GetKeyDown(gazeClickKey) || OVRInput.GetDown(joyPadClickButton) || InputController.controllers[1].triggerDown;
			var released = Input.GetKeyUp(gazeClickKey) || OVRInput.GetUp(joyPadClickButton) || InputController.controllers[1].triggerUp;
