...
public class ViveControllerInput : BaseInputModule
{
    ...
    {
		ControllerCamera.transform.position = Controllers[index].transform.Find("UIRayOrigin").position;
		ControllerCamera.transform.forward = Controllers[index].transform.Find("UIRayOrigin").forward;
    }
